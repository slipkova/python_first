...
print(f'\tVypíše všechny hodnoty z mixed_list kromě dvou posledních: {mixed_list[:len(mixed_list)-2]}')
...
#b
ascii = [choice(ascii_uppercase) for i in range(50)]
print(ascii)
...
#b
women = [i for i in persons if i[2] == "žena"]
print(women)
women = list(filter(lambda persons: persons[2] == "žena", persons))
print(women)

#c
ipeople = [i for i in persons if "i" in i[0].lower()]
print(ipeople)
ipeople = list(filter(lambda persons:  "i" in persons[0].lower(), persons))
print(ipeople)