...
for i in range(1, 6):
    print(dateutil.easter.easter(int(datetime.datetime.now().strftime("%Y")) + i))

#3
print(rrule(YEARLY, bymonth=12, bymonthday=24, byweekday=SU).after(datetime.datetime.now()))