...
def solve(a, b):
    '''
    This function returns characters that are unique
    (are only in one of the passed strings)

    This is a kata from codewars:
    https://www.codewars.com/kata/reviews/5a263695ef5e67effc0001a1/groups/5f55ecc915fbdc00017a23ca
    '''
    print("".join(is_in(a, b)) + "".join(is_in(b, a)))
